          ...
          <div class="card-body p-3">
            <div class="d-flex flex-wrap justify-content-between align-items-center">
              ...
              <div class="d-flex document-actions">
                <a href="download.php?id=<?php echo $documentId; ?>" class="btn btn-outline-primary btn-sm mr-2">
                  <i class="ti-download mr-1"></i> Download
                </a>
                <?php if ($_SESSION['user_id'] == $document['UserID'] || $_SESSION['user_role'] == 'admin'): ?>
                <a href="delete.php?id=<?php echo $documentId; ?>" class="btn btn-outline-danger btn-sm delete-doc">
          ...
          <div class="card-body p-0 position-relative">
            <div class="document-viewer-toolbar bg-light p-2 border-bottom">
              <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                  <a href="download.php?id=<?php echo $documentId; ?>" class="btn btn-sm btn-light">
            ...
            <div class="document-viewer" id="document-viewer">
              ...
              if ($fileType == 'pdf') {
                ...
                echo '<a href="download.php?id=' . $documentId . '" class="btn btn-primary"><i class="ti-download mr-1"></i> Download File</a>';
                echo '</div>';
              }
              ?>
            </div>
      ...
      <div class="col-md-3">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="mt-4">
              <a href="download.php?id=<?php echo $documentId; ?>" class="btn btn-primary btn-block">
                <i class="ti-download mr-1"></i> Download
              </a>
              <?php if ($_SESSION['user_id'] == $document['UserID'] || $_SESSION['user_role'] == 'admin'): ?>
              <a href="delete.php?id=<?php echo $documentId; ?>" class="btn btn-outline-danger btn-block mt-2 delete-doc">
                <i class="ti-trash mr-1"></i> Delete
              </a>
              <?php endif; ?>
            </div>
