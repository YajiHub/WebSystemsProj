      ...
      <div class="col-md-12 grid-margin">
        <div class="row">
          <div class="col-12 col-xl-8 mb-4 mb-xl-0">
            ...
            <h6 class="font-weight-normal mb-0">View and restore your deleted documents</h6>
          </div>
                  ...
                  <?php else: ?>
                    <?php foreach ($trashedDocuments as $doc): ?>
                      <tr>
                        ...
                        <td>
                          <a href="admin-restore.php?id=<?php echo $doc['DocumentID']; ?>" class="btn btn-success btn-icon-text btn-sm">
                            <i class="ti-reload"></i> Restore
                          </a>
                          <a href="admin-permanent-delete.php?id=<?php echo $doc['DocumentID']; ?>" class="btn btn-danger btn-icon-text btn-sm permanent-delete">
  ...
  <div class="modal fade" id="emptyTrashModal" tabindex="-1" role="dialog" aria-labelledby="emptyTrashModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
          <a href="admin-empty-trash.php" class="btn btn-danger">Empty Trash</a>
        </div>
      </div>
    </div>
  </div>
